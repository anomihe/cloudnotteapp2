...
class ResponseSuccess<T> {
  ...
  factory ResponseSuccess.fromJson(Map<String, dynamic> data,
      T Function(Map<String, dynamic> jsonData) fromJsonT, String value) {
  ...
  //   dynamic dataT;
  //   if (T is UserModel) {
  //     dataT = UserModel.fromJson(data['data']);
  //   }
  //   return ResponseSuccess(
  //     data: dataT,
  //     success: data['success'],
