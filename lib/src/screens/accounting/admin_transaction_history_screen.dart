...
class AdminTransactionHistoryScreen extends StatefulWidget {
  static const routeName = '/AdminTransactionHistoryScreen';
...
class _AdminTransactionHistoryScreenState extends State<AdminTransactionHistoryScreen> {
  ...
  final Map<String, List<AdminTransactionModel>> _groupedTransactions = {};
  ...
  void _groupTransactions(List<AdminTransactionModel> transactionsList) {
    ...
    final sortedMap = Map<String, List<AdminTransactionModel>>.fromEntries(
...
bool _didGroupTransactions = false;
  ...
  Widget _buildMonthSection(
      String monthYear, List<AdminTransactionModel> transactions) {
    return Theme(
  ...
  Widget _buildTransactionCard(AdminTransactionModel transaction) {
  ...
  void _handleSort(SortOption option, List<FeePayment> feePayments) {
    setState(() {
      ...
      List<AdminTransactionModel> allTransactions =
          _convertToTransactionModels(feePayments);

      // Then filter based on sort option
      List<AdminTransactionModel> sortedList;
  ...
  List<AdminTransactionModel> _convertToTransactionModels(
    ...
    return feePayments.map((payment) {
      ...
      final status = (payment.status ?? '').toUpperCase() == 'SUCCESSFUL'
