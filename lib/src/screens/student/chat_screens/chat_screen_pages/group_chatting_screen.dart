...
import 'package:cloudnottapp2/src/screens/student/chat_screens/chat_screen_widgets/group_chatting_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:flutter_svg/svg.dart';

class GroupChattingPage extends StatefulWidget {
  const GroupChattingPage({super.key, required this.userChatModel});
  static const String routeName = '/group_chatting_page';
          ...
          children: [
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) => GroupChattingWidget(
